...
export type { ERC20Token } from "./contracts/mytoken.sol/ERC20Token";
export { ERC20Token__factory } from "./factories/contracts/mytoken.sol/ERC20Token__factory";
export type { SimpleSwap } from "./contracts/SimpleSwap";
export { SimpleSwap__factory } from "./factories/contracts/SimpleSwap__factory";
export type { StakingContract } from "./contracts/staking.sol/StakingContract";
export { StakingContract__factory } from "./factories/contracts/staking.sol/StakingContract__factory";
export type { VestingContract } from "./contracts/vesting.sol/VestingContract";
export { VestingContract__factory } from "./factories/contracts/vesting.sol/VestingContract__factory";
